                    ...
                    <div className="widget widget-about footer-widget">
                        <div className="footer-logo footer-img">
                            <Link href="/pages/homepage/home-1">
                                <img src="/main-assets/img/logo.png" alt="logo" width={100} height={50} />
                            </Link>
                        </div>
                            ...
                            <div className="row align-items-center justify-content-lg-start justify-content-between">
                                <div className="col-auto">
                                    <div className="header-logo">
                                        <Link href="/pages/homepage/home-1"><img src="/main-assets/img/logo.png" alt="logo" /></Link>
                                    </div>
                                </div>
                                ...
                                <div className="col-auto d-xl-block d-none space-left">
                                    <div className="header-button">
                                        ...
                                        <Link href="/pages/innerpage/about" className="btn d-xxl-flex d-none">GET IN TOUCH <i className="ri-arrow-right-up-line"></i></Link>
