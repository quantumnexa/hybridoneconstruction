                            ...
                            <div className="row align-items-center justify-content-lg-start justify-content-between">
                                <div className="col-auto">
                                    <div className="header-logo">
                                        <Link href="/pages/homepage/home-1">
                                            <img src="/main-assets/img/logo-white.svg" alt="logo" />
                                        </Link>
                                    </div>
                                </div>
                                ...
                                <div className="col-auto d-xl-block d-none">
                                    <div className="header-button">
                                        ...
                                        <Link href="/pages/innerpage/about" className="btn style2 d-xxl-flex d-none">GET IN TOUCH <i className="ri-arrow-right-up-line"></i></Link>
