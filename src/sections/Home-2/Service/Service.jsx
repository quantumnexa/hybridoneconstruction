                        ...
                        <div className="col-xl-3 col-md-6 service-card-list">
                            <div className="service-card style2">
                                ...
                                <div className="service-card_content">
                                    ...
                                    <h4 className="service-card_title"><Link href="/pages/innerpage/service-details">PRE CONSTRUCTION</Link></h4>
                                    <p className="service-card_text">We develop detailed budgets, cost-control systems, and feasibility analysis before a dollar is spent preventing financial surprises later.</p>
                        ...
                        <div className="col-xl-3 col-md-6 service-card-list">
                            <div className="service-card style2">
                                ...
                                <div className="service-card_content">
                                    ...
                                    <h4 className="service-card_title"><Link href="/pages/innerpage/service-details">DESIGN + BUILD</Link></h4>
                                    <p className="service-card_text">One streamlined team. Faster completion. Clear accountability.  Our integrated process reduces delays and improves cost efficiency by up to 33%.</p>
                                    <div className="btn-wrap">
                                        <Link href="/pages/innerpage/service-details" className="btn-with-icon">
                                            READ MORE
                                            <span className="btn-icon">
                        ...
                        <div className="col-xl-3 col-md-6 service-card-list">
                            <div className="service-card style2">
                                ...
                                <div className="service-card_content">
                                    ...
                                    <h4 className="service-card_title"><Link href="/pages/innerpage/service-details">GENERAL CONTRACTING</Link></h4>
                                    <p className="service-card_text">We manage permitting, scheduling, procurement, and on-site supervision to keep projects on time and on budget</p>
                                    <div className="btn-wrap">
                                        <Link href="/pages/innerpage/service-details" className="btn-with-icon">
                                            READ MORE
                                            <span className="btn-icon">
                        ...
                        <div className="col-xl-3 col-md-6 service-card-list">
                            <div className="service-card style2">
                                ...
                                <div className="service-card_content">
                                    ...
                                    <h4 className="service-card_title"><Link href="/pages/innerpage/service-details">CONSTRUCTION MANAGEMENT</Link></h4>
                                    <p className="service-card_text">On-site supervision, contractor coordination, cost control, scheduling, and full project oversight so your project runs smoothly and stays protected.</p>
                                    <div className="btn-wrap">
                                        <Link href="/pages/innerpage/service-details" className="btn-with-icon">
                                            READ MORE
                                            <span className="btn-icon">
                    ...
                    <div className="cta-wrap2">
                        ...
                        <div className="cta-contact-grid">
                            ...
                            <div className="cta-contact-grid-details">
                                <Link className="link" href="tel:+123551579209">+2 81 831 1880</Link>
                                <h6 className="title">Mon - Fri : 10am - 07pm</h6>
                            </div>
                        </div>
                    </div>
                </div>
