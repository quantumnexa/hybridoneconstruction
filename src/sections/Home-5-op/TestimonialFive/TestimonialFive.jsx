                                ...
                                <div className="testi-card style5">
                                    <div className="testi-card-profile">
                                        ...
                                        <div className="testi-card-profile-details">
                                            ...
                                            <span className="testi-profile-desig">Designer at Rainbow Themes</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="testi-card_content">
                                        ...
                                        <p className="testi-card_text">When an unknown printer took a galley of type and scrambled it to make a type specimen book, It has survived not only five centuries.</p>
