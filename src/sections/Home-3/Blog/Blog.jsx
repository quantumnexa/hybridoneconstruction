...
const Blog = () => {
    return (
        <section className="blog-area-2 space shape-mockup-wrap">
            ...
            <div className="container">
                ...
                <div className="row global-carousel blog-slider slider-shadow" data-slide-show="3" data-lg-slide-show="2" data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1" data-dots="false">
