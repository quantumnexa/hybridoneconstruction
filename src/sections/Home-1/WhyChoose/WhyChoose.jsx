        ...
        <div className="space-top text-center overflow-hidden shape-mockup-wrap">
            ...
            <div className="container">
                <div className="title-area text-center">
                    ...
                    <span className="sub-title"><img src="/main-assets/img/icon/section-subtitle-icon.svg" alt="img" /> Why Choose Us</span>
                        ...
                        <div className="wcu-card-wrap left-align">
                            ...
                            <div className="wcu-card">
                                ...
                                <div className="wcu-card-details">
                                    ...
                                    <p className="wcu-card-text">All the Lorem Ipsum generators on the Internet tend to repeat predefined</p>
                                </div>
                            </div>
                            <div className="wcu-card">
                                <div className="wcu-card-icon">
                        ...
                        <div className="wcu-card-wrap right-align">
                            <div className="wcu-card">
                                ...
                                <div className="wcu-card-details">
                                    ...
                                    <p className="wcu-card-text">Passage of Lorem Ipsum, you need to be sure there isn't anything</p>
                                </div>
                            </div>
                            <div className="wcu-card">
                                <div className="wcu-card-icon">
