          ...
          <div className="col-xl-4 col-md-6">
            <div className="service-card">
              ...
              <div className="service-card_content">
                ...
                <h4 className="service-card_title">
                  <Link href="/pages/innerpage/service-details">Property maintenance</Link>
                </h4>
                <p className="service-card_text">
                  There are many passages of lorem ipsum available
                </p>
          ...
          <div className="col-xl-4 col-md-6">
            <div className="service-card">
              ...
              <div className="service-card_content">
                ...
                <h4 className="service-card_title">
                  <Link href="/pages/innerpage/service-details">Project management</Link>
                </h4>
                <p className="service-card_text">
                  There are many passages of lorem ipsum available
                </p>
          ...
          <div className="col-xl-4 col-md-6">
            <div className="service-card">
              ...
              <div className="service-card_content">
                ...
                <h4 className="service-card_title">
                  <Link href="/pages/innerpage/service-details">Virtual design & build</Link>
                </h4>
                <p className="service-card_text">
                  There are many passages of lorem ipsum available
                </p>
            ...
            <div className="service-card">
              ...
              <div className="service-card_content">
                ...
                <h4 className="service-card_title h5">
                  <Link href="/pages/innerpage/service-details">Proconstruction</Link>
                </h4>
                <p className="service-card_text">
                  There are many passages of lorem ipsum available
                </p>
